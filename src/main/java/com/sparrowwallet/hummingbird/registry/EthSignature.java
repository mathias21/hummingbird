...
public class EthSignature extends RegistryItem {
    ...
    public EthSignature(byte[] signature) {
        this.requestId = null;
        this.signature = signature;
    }

    public EthSignature(byte[] signature, byte[] requestId) {
    ...
    public static EthSignature fromCbor(DataItem item) {
        byte[] requestId = null;
        byte[] signature = null;
        ...
        if(requestId != null) {
            ...
            return new EthSignature(signature);
        }
    }
}
